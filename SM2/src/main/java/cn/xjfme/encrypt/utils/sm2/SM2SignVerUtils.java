...
public class SM2SignVerUtils {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SM2SignVO sign = Sign2SM2(Util.hexStringToBytes(privatekey), sourceData);
        long endSignTime = System.currentTimeMillis();
        System.out.println(endSignTime - startSignTime);
        SM2SignVO verify = VerifySignSM2(Util.hexStringToBytes(publicKey), sourceData, Util.hexStringToBytes(sign.getSm2_signForSoft()));
        long endVerifyTime = System.currentTimeMillis();
        System.out.println(endVerifyTime - endSignTime);
